...
class _DetailChangeScreenState extends State<DetailChangeScreen> {
  ...
  final GlobalKey<FormState> _detailChangeFormKey = GlobalKey<FormState>();
  ...
  void initState() {
    ...
    items = categorySequence.map((label) => DropdownItem(label: label, value: label)).toList();
